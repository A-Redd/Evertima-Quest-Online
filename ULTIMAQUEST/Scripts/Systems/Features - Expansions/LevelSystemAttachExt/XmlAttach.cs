...
namespace Server.Engines.LevelSystemExtAtt
{
	...
	public class XmlAttachExt
	{
		...
		public class ErrorReporter
		{
			...
			{
				Console.Write("LevelSystemExtAtt Attachment error: Sending email...");
				...
				message.Subject = "Automated LevelSystemExtAtt Attachment Error Report";

				message.Body = "Automated LevelSystemExtAtt Attachment Report. See attachment for details.";
			...
			public static void GenerateErrorReport(string error)
			{
				...
				try
				{
					...
					using (StreamWriter op = new StreamWriter(filePath))
					{
						...
						op.WriteLine("LevelSystemExtAtt Attachment Error Report");
						op.WriteLine("===================");
						op.WriteLine();
						op.WriteLine("RunUO Version {0}.{1}.{3}, Build {2}", ver.Major, ver.Minor, ver.Revision, ver.Build);
						op.WriteLine("Operating System: {0}", Environment.OSVersion);
						op.WriteLine(".NET Framework: {0}", Environment.Version);
//						op.WriteLine("LevelSystemExtAtt: {0}", XmlSpawnerExt.Version);
